        ...
        for option in options:
            for offset in offsets:
                ...
                if len(cards) > 0:
                    ...
                    self.base_url = "https://store.nintendo.co.uk/en_gb/games/enhance-your-play/amiibo/"
                    ...
                    cards = soup.find_all(
                        "div",
                        attrs={
                            "class": lambda e: e.startswith("col-6") if e else False
                        },
                    )
                    ...
                    for card in cards:
                        ...
                        price = card.find_all(
                            "data",
                            attrs={
                                "class": lambda e: e.startswith("value") if e else False
                            },
                        )
